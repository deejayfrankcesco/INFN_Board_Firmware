# 
# Project automation script for ise_project 
# 
...
proc add_source_files {} {
   ...
   xfile add "../IP/system_clock/system_clock.xco"
   ...
   xfile add "../lib/fpga-ip/SPECIFIC/DOIN/doin_i2cDACcontrollerBasic/rtl/i2cFSM.vhd"
   xfile add "../lib/fpga-ip/TRIGGER/Trigger_System/rtl/trigger_system.vhd"
   xfile add "../lib/fpga-ip/UTILITY/LED_stretcher/rtl/LED_stretcher.vhd"
   xfile add "../lib/fpga-ip/UTILITY/Pulse_Gen/rtl/Pulse_Gen.vhd"
   xfile add "../lib/fpga-ip/UTILITY/Reset_Controller/rtl/reset_controller.vhd"
   xfile add "../lib/fpga-ip/UTILITY/synchronizer/rtl/synchronizer.vhd"
   xfile add "../lib/fpga-ip/UTILITY/timestamp/rtl/timestamp.vhd"
   xfile add "../rtl/top/back_end_top.vhd"
   xfile add "../vrf/back_end_top_tb.vhd"
   puts ""
...
proc set_process_props {} {
   ...
   project set "Work Directory" "/home/ise/frankcesco/Documents/offline/INFN_Board_Firmware/ise_project/xst" -process "Synthesize - XST"
   ...
   project set "Output File Name" "back_end_top" -process "Generate IBIS Model"
